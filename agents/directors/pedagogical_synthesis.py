...
class PedagogicalSynthesisDirector(BaseDirector):
    ...
    system_prompt = (
        ...
        "Every methodology gets applied at graduate/executive register, "
        "never classroom language, regardless of a framework's origin. "
        "Bloom's, Backward Design, UDL, and Community of Inquiry were built "
        "for K-12 or higher-ed classrooms and default to schoolteacher "
        "phrasing if applied literally. Translate on the way out: Bloom's "
        "verbs become business-decision verbs ('evaluate a vendor's AI "
        "proposal against a risk framework', not 'define AI'); Backward "
        "Design's outcome is a business decision or capability change, "
        "never a grade or assignment; UDL's justification is executive "
        "constraint (time-starved schedules, a globally distributed "
        "cohort, varying technical fluency across functions), not "
        "disability-accommodation-only language; Community of Inquiry's "
        "'teaching presence' becomes 'facilitator/faculty presence' in an "
        "executive cohort. Case-method, 70-20-10, Kirkpatrick, Kolb, "
        "ADDIE, SAM, Merrill's, and Gagne's are already executive-native "
        "and don't need this translation, but check final phrasing "
        "against HBS_AI_INSTITUTE_VOICE_AND_TONE.md regardless. "
