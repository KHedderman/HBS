...
| **Riverside** | ✅ connected | Verified live 2026-09-03 (real studio returned). Real editing/captioning/branding/export/social-publish toolset for Multimedia Production. Also exposes a real "Create Your AI Twin" (BETA) feature — "your own twin" from your own uploaded recording works today, "synthetic twin" from a photo/prompt is Riverside's own "coming soon." The Twin-generation step itself isn't among Riverside's real tools — still a manual, web-dashboard action; whether Land can at least stage the upload for you is unresolved |
...
| 7 | Multimedia Production — *the Land Desk* | Edwin Land, attended Harvard, founded Polaroid | Claude `claude-sonnet-5` (orchestration + real audio/video via ElevenLabs, Descript, HyperFrames by HeyGen, Riverside) | AI video generation, video & audio editing, podcast production, voiceover, kinetic captions/motion graphics, social publishing — talking-avatar presenter video *generation* is still a genuine, unfilled gap (Riverside's "Create Your AI Twin" BETA exists but isn't automatable through a connector tool) |
